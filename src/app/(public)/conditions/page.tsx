...
const CONDITIONS = [
  {
    ...
    content: "Geora ofrece planes de suscripción pagos para inmobiliarias que deseen publicar propiedades en la Plataforma."
  },
  {
    id: 2,
    title: "2. Planes",
    ...
    content: (
      <>
        <p>Geora podrá ofrecer distintos planes, incluyendo:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>Geora podrá otorgar un período de prueba gratuito de 30 días.</p>
        ...
        <p className="mt-2">Asimismo, Geora podrá otorgar planes promocionales gratuitos por tiempo limitado.</p>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-2 text-geora-black/90 font-bold">Geora no será responsable por fallas en sistemas de terceros.</p>
      </>
    )
  },
  {
    ...
    title: "6. Facturación",
    icon: <FileText size={18} className="text-geora-black/60" />,
    content: "Geora emitirá las facturas correspondientes conforme a la normativa vigente en la República Argentina."
  },
  {
    id: 7,
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 mt-1 space-y-1 text-geora-black/80 font-medium">
        ...
        <ul className="list-disc pl-5 mt-1 space-y-1 text-geora-black/80 font-medium">
          <li>Geora podrá bloquear la cuenta.</li>
          <li>Se eliminarán las publicaciones.</li>
          <li>Se restringirá el acceso a la plataforma.</li>
        </ul>
        <p className="mt-2 font-bold text-geora-black/90">Todo ello sin derecho a reclamo ni indemnización alguna.</p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-2 text-geora-black/90 font-bold">La cancelación no dará derecho a reembolsos.</p>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    icon: <FileText size={18} className="text-geora-black/60" />,
    content: "Geora podrá modificar precios, planes, condiciones y servicios en cualquier momento, incluyendo la incorporación de otros servicios inmobiliarios."
  },
  {
    id: 11,
    title: "11. Responsabilidad",
    icon: <ShieldCheck size={18} className="text-geora-black/60" />,
    content: <p className="font-bold text-geora-black/90">El uso del servicio se realiza bajo exclusiva responsabilidad del Usuario.</p>
  }
];
