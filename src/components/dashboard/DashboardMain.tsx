    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full overflow-hidden transform transition-all">
        ...
        <div className="flex items-center gap-3 p-4 bg-gray-50">
          <button onClick={onClose} disabled={isLoading} className="flex-1 cursor-pointer px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-urbik-black/70 hover:border-urbik-white rounded-full hover:bg-urbik-black/70 hover:text-urbik-white disabled:opacity-50">Cancelar</button>
          <button onClick={onConfirm} disabled={isLoading} className="flex-1 cursor-pointer px-4 py-2 text-sm font-medium border border-urbik-white text-white bg-urbik-rose rounded-full hover:bg-urbik-white hover:text-urbik-rose hover:border-urbik-rose disabled:opacity-50 flex justify-center items-center">
...
export default function DashboardMain({ properties, onRefresh, autoOpenCreate = false }: { properties: PropertySummary[]; onRefresh: () => void; autoOpenCreate?: boolean; }) {
            ...
            <div className="p-2 sm:p-4">
              {properties.length === 0 ? (
                <div className="text-center py-16 flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-500 max-w-sm">Cargá tu primera propiedad usando el botón de arriba.</p>
                </div>
              ) : (
          ...
          <div className="lg:sticky lg:top-24 space-y-6">
            <div className="rounded-md border border-gray-100 bg-white shadow-sm overflow-hidden">
              ...
              <div className="p-5 border-t border-gray-100 flex items-center justify-between">
                <span className="text-xs font-bold text-gray-500">Último mes</span>
                <span className="text-xl font-black text-gray-900">{lastMonthViews}</span>
              </div>
            </div>
            ...
            <div className="rounded-md border border-gray-100 bg-white shadow-sm overflow-hidden">
              ...
              <div className="h-40 bg-gray-100 relative">
                {mostViewed?.images?.[0] ? <img src={mostViewed.images[0]} alt="Most viewed" className="object-cover w-full h-full" /> : <div className="w-full h-full flex items-center justify-center text-gray-400 font-bold bg-gray-50">Sin imagen</div>}
              </div>
              <div className="p-5">
