...
export default function SmartZoneSingle({ property }: { property: any }) {
  const [analysis, setAnalysis] = useState<{ score: number; verdict: string } | null>(null);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center  mr-15">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-white mb-6 leading-none tracking-tighter uppercase">
                URBIK SMART <br /> 
                <span className="text-urbik-emerald italic text-6xl md:text-8xl block mt-1 -ml-5">ZONE</span>
              </h2>
              ...
              <div className="flex gap-4 mt-2">
                <div className="h-28 w-28 bg-urbik-emerald/10 border border-urbik-emerald/20 rounded-2xl flex flex-col items-center justify-center backdrop-blur-sm">
                  ...
                  <span className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-1">Score Zona</span>
                </div>
                <div className="h-28 w-28 bg-white/5 border border-white/10 rounded-2xl flex flex-col items-center justify-center backdrop-blur-sm">
                  ...
                  <span className="text-[9px] text-gray-500 font-bold uppercase tracking-widest mt-1">Engine v2.1</span>
                </div>
              </div>
            </div>

            <div className="lg:col-span-8 relative">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 min-h-[220px] 
              ...
              <div className="mt-4 flex justify-between items-center px-2">
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${loadingAi ? 'bg-gray-600' : 'bg-urbik-emerald animate-pulse shadow-[0_0_8px_rgba(16,185,129,1)]'}`} />
                ...
                <div className="text-[10px] text-urbik-emerald/60 font-bold uppercase tracking-widest flex gap-4">
                  <span className={loadingAi ? "opacity-20" : "opacity-100 transition-opacity"}>Market Gap: OK</span>
                  <span className={loadingAi ? "opacity-20" : "opacity-100 transition-opacity"}>ROI: Calculated</span>
                </div>
              </div>
            </div>
