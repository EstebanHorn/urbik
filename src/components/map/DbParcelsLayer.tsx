...
import { getDynamicParcelStyle } from "./utils";
  ...
  return (
    <>
      {properties.map((rawProp) => {
        ...
        const dynamicStyle = getDynamicParcelStyle(prop as MapProperty, colorMode);
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="h-28 w-full relative parcel-layer-shadow">
                      ...
                      <div className="absolute bottom-2 left-2 bg-urbik-cyan text-urbik-dark text-[8px] px-1.5 py-0.5 rounded font-black z-10">
