...
import { MapEventsHandler, type ZoneData } from "./MapEventsHandler";
import { SelectedParcelLayer } from "./MapTools";
import { mapBaseLayers, type BaseLayerId } from "./types";
import { detectRegion, type Region } from "./utils";
import { useMapEvents } from "react-leaflet";
import { useMapSettings } from "./MapSettingsProvider";
import type { MapProperty, MapBounds, SelectedParcel } from "./types";
...
function MapUpdater({ center }: { center: [number, number] }) {
  ...
  useEffect(() => {
    ...
    const mapInstance = map as unknown as { _loaded: boolean };
