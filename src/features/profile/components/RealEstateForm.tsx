      ...
      {form.bannerUrl ? (
        ...
        <div className="flex items-center gap-2 text-urbik-muted opacity-30">
          ...
          <div className=" flex flex-col sm:flex-row gap-4">
            <button type="button" className="flex-1 cursor-pointer py-3 bg-urbik-white border border-dashed border-urbik-black/20 rounded-full text-xs font-bold text-urbik-muted hover:bg-urbik-black hover:text-white transition-all flex items-center justify-center gap-2">
...
<div className="flex justify-end pt-4">
            <button 
              type="submit" 
              disabled={loading} 
              className="px-10 py-5 bg-urbik-black cursor-pointer text-white font-bold rounded-full transition-all flex items-center justify-center gap-3 active:scale-95 hover:bg-urbik-emerald shadow-xl"
            >
